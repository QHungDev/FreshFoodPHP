                ...
                <div class="col-7">
                    <div class="summary">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="freshfoodstore/">Trang chủ</a></li>
                                <li class="breadcrumb-item"><a href="list-product.html"><?php echo $result_details['brandName']?></a></li>
                        ...
                        <div class="button">
                            <a href="cart.html" name="addProduct" class="btn btn-outline-success btn-text">
